...
'toolbar=no, location=no, directories=no, status=yes, scrollbars=yes, resizable=yes, copyhistory=no, width=600, height=350'); return false;">Ajouter au panier</a> -->
            ...
            {
                ?>
                <button class="btn margin-auto bg-primary text-light" onclick="<?php $_SESSION['cart_time'] = time(); ?>" ><a class="text-light" href="?uc=gererManga&action=consulterManga&id=<?php echo $leManga->getID() ?>&panier=ajouter&vol=<?= $i ?>"><?= $ajout_panier ?></a>
                </button>
                <?php
            } else
            {
